<x-AppLayout>
    <div class="w-full bg-azul-semi"> <video autoplay muted loop class="inset-0 w-full h-full object-cover"
        ...
        <h1 class="text-6xl text-white text-center font-bold text-left px-20 bg-guiamath-bg dark:text-white"
            style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);"> Ejercicios Resueltos de
            Matemáticas para Ingeniería </h1>
    </div>
        ...
        <tr>
          <td class="w-80 p-8">
            <div class="flex justify-center">
              <img src="https://res.cloudinary.com/dbltc2gr7/image/upload/v1682448978/2_pn5kcr.png" width="200">
            </div>
            <h2 class="text-center font-bold mt-4">Ver ejercicios resueltos</h2>
          </td>
          <td class="w-80 p-8">
            <div class="flex justify-center">
              <img src="https://res.cloudinary.com/dbltc2gr7/image/upload/v1682448978/3_otazkw.png" width="200">
            </div>
            <h2 class="text-center font-bold mt-4">Ver ejercicios resueltos en video</h2>
          </td>
          <td class="w-80 p-8">
            <div class="flex justify-center">
              <img src="https://res.cloudinary.com/dbltc2gr7/image/upload/v1682448978/4_yltngi.png" width="200">
            </div>
