...
<nav class="bg-azul-semi" x-data="{ open: false }">
      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <div class="relative ml-3" x-data="{open:false}">
            ...
            <div style="display:none" x-show="open" x-on:click.away="open = false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              ...
              <a href="{{route('exerciseuser.index')}}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Mis ejercicios</a>
              <!-- Authentication -->
        ...
        @else
            <button class="bg-blue-900 rounded-full px-4 py-2">
              <a href="{{ route('login')}}" class="text-gray-300 hover:bg-blue-900 hover:text-white rounded-full px-4 py-2 text-sm font-medium">Inicio de sesión</a>
            </button>
            <a href="{{ route('register')}}" class="text-gray-300 hover:bg-blue-900 hover:text-white rounded-full px-4 py-2 text-sm font-medium">Registrarse</a>             
        @endauth
