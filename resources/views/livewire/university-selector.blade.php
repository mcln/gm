<div class="flex flex-row min-h-screen">
    ...
    <div class="w-1/6 p-6 bg-gray-100 border-r">
        ...
        <div class="mb-4">
            ...
            <select id="country" wire:model="selectedCountry" class="w-full border rounded p-2 text-sm">
        ...
        <div class="mb-4">
            ...
            <select id="university" wire:model="selectedUniversity" class="w-full border rounded p-2 text-sm">
        ...
        @if ($selectedUniversity)
            <div class="mb-4">
                ...
                <select id="subject" wire:model="selectedSubject" class="w-full border rounded p-2 text-sm">
