<x-AppLayout>
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 py-8">
        <div class="flex rounded-lg bg-azul-oscuro py-2 px-4 items-center">
            <a href="{{ route('exercises.sector', $item->section->chapter->sector->id) }}" class="inline-flex items-center bg-azul-oscuro hover:bg-azul-electrico text-white font-bold py-1 px-3 rounded-full">
            ...
            <a href="{{ route('exercises.chapter', $item->section->chapter->id) }}" class="inline-flex items-center bg-azul-oscuro hover:bg-azul-electrico text-white font-bold py-1 px-3 rounded-full">
                {{ ucfirst($item->section->chapter->name) }}
            </a>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline-block mx-2" fill="none" viewBox="0 0 24 24" stroke="#ffffff" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M13 5l7 7-7 7M5 5l7 7-7 7" />
            </svg>
            <a href="{{ route('exercises.section', $item->section->id) }}" class="inline-flex items-center bg-azul-oscuro hover:bg-azul-electrico text-white font-bold py-1 px-3 rounded-full">
        ...
        <div class="rounded-lg grid grid-cols-1 gap-1 py-4 px-4 bg-azul-oscuro">
            <div class="image-section h-7 rounded-lg w-400 h-300 flex items-center bg-azul-muyclaro py-1 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" class="ml-4 h-5 w-5" viewBox="0 0 20 20" fill="#0F4069">
                  ...
                  </svg><span class="ml-4 font-bold italic text-azul-oscuro">Click en el ejercicio para ver el desarrollo</span>
            </div>
